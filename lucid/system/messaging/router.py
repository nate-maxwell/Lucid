...
class Router(types.ModuleType):
    ...
    def _setup_routes(self) -> None:
        ...
        self.register_route(lucid.const.RENDER_CHAN, StandardChannel(lucid.const.RENDER_CHAN))
        self.register_route(lucid.const.INVALID_CHAN, StandardChannel(lucid.const.INVALID_CHAN))
