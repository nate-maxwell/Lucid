...
class UnrealAssetBrowser(LucidFileBrowser):
    def __init__(self):
        ...
        super().__init__(columns, lucid.config_paths.PROJECTS_PATH, (1024, 850), (1280, 850))
        ...
        projects = lucid.io_utils.list_folder_contents(lucid.config_paths.PROJECTS_PATH)
